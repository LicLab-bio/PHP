(function (d) {
    ...
    b.prototype.setLanguage = function () {
        ...
        switch (this.option.lang) {
            case "cn":
                f = { select_all_btn: "选择所有 (或当前页签) 项目", remove_all_btn: "清除所有选中的项目", close_btn: "关闭菜单 (Esc键)", loading: "读取中...", select_ng: "请注意：请从列表中选择.", select_ok: "OK : 已经选择.", not_found: "无查询结果", ajax_error: "连接到服务器时发生错误！" };
                break;
            case "en":
                ...
                break;
            case "ja":
                f = { select_all_btn: "すべての （または現在のタブ） 項目を選択", remove_all_btn: "選択したすべての項目をクリアする", close_btn: "閉じる (Tabキー)", loading: "読み込み中...", select_ng: "注意 : リストの中から選択してください", select_ok: "OK : 正しく選択されました。", not_found: "(0 件)", ajax_error: "サーバとの通信でエラーが発生しました。" };
                break;
            case "de":
                f = { select_all_btn: "Wählen Sie alle (oder aktuellen Registerkarten) aus", remove_all_btn: "Alle ausgewählten Elemente löschen", close_btn: "Schließen (Tab)", loading: "lade...", select_ng: "Achtung: Bitte wählen Sie aus der Liste aus.", select_ok: "OK : Richtig ausgewählt.", not_found: "nicht gefunden", ajax_error: "Bei der Verbindung zum Server ist ein Fehler aufgetreten." };
                break;
            case "es":
                f = { select_all_btn: "Seleccionar todos los elementos (o la pestaña actual)", remove_all_btn: "Borrar todos los elementos seleccionados", close_btn: "Cerrar (tecla TAB)", loading: "Cargando...", select_ng: "Atencion: Elija una opcion de la lista.", select_ok: "OK: Correctamente seleccionado.", not_found: "no encuentre", ajax_error: "Un error ocurrió mientras conectando al servidor." };
                break;
            case "pt-br":
    ...
    b.prototype.displayResults = function (w, v, l) {
        ...
        if (g.multiple && d.type(g.maxSelectLimit) === "number" && g.maxSelectLimit > 0) {
            ...
            if (j > 0 && j >= g.maxSelectLimit) {
                w.showMessage(w, "最多只能选择 " + g.maxSelectLimit + " 个项目");
                return;
            }
        }
