...
$tf_expression_sql = "SELECT *
        from $Normal_tissue_GTEX_TF_Exp_tpm_final_ok
...
if (empty($data)) $data = ",,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,";
$data = "[" . $data . "]";
$name = "['Adipose Tissue', 'Adrenal Gland', 'Blood Vessel', 'Bladder', 'Brain', 'Breast', 'Blood', 'Skin', 'Cervix Uteri', 'Colon', 'Esophagus', 'Fallopian Tube', 'Heart', 'Kidney', 'Liver', 'Lung', 'Salivary Gland', 'Muscle', 'Nerve', 'Ovary', 'Pancreas', 'Pituitary', 'Prostate', 'Small Intestine', 'Spleen', 'Stomach', 'Testis', 'Thyroid', 'Uterus', 'Vagina']";
?>
<script type="text/javascript">
    ...
    option = {
        title: {
            text: '<?php echo $sample_tf_name?> Expression in Human Normal Tissues (GTEx)',
            x: 'center'
        },
        tooltip: {
            trigger: 'axis'
        ...
        xAxis: [
            {
                ...
                nameGap: 40,
                type: 'category',
                data: ['Adipose Tissue', 'Adrenal Gland', 'Blood Vessel', 'Bladder', 'Brain', 'Breast', 'Blood', 'Skin', 'Cervix Uteri', 'Colon', 'Esophagus', 'Fallopian Tube', 'Heart', 'Kidney', 'Liver', 'Lung', 'Salivary Gland', 'Muscle', 'Nerve', 'Ovary', 'Pancreas', 'Pituitary', 'Prostate', 'Small Intestine', 'Spleen', 'Stomach', 'Testis', 'Thyroid', 'Uterus', 'Vagina'],
                axisTick:
                    {
                        show: true,
                        alignWithLabel: 'ture',
