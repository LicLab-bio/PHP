        ...
        <div class="col-lg-6">
            <div>
                ...
                <p class="p-1" style="font-size:18px; ">
                    Here, we developed the TF-Marker database (TF-Marker, http://bio.liclab.net/TF-Marker/) which is committed to a comprehensive manual curation of TFs and related markers with experimental evidence in specific cell and tissue types in human. Currently, through reviewing <b style="color:green">2,091</b> published literature, we have manually classified TFs and related markers into five types according to their functions: 1) <b style="color:green">TF</b>: TFs, which regulate the expression of markers; 2) <b style="color:green">T Marker</b>: markers, which are regulated by TFs (TF and T Marker pairs can identify cell types more specifically); 3) <b style="color:green">I Marker</b>: markers, which influence the activity of TFs (I Markers can also influence the development of specific cells and tissues); 4) <b style="color:green">TFMarker</b>: TFs, which play roles as markers (TFMarkers are cell/tissue-specific TFs used as cell markers in biology experiments); and 5) <b style="color:green">TF Pmarker</b>: TFs, which play roles as potential markers. By curating thousands of published literature, <b style="color:green">5,905</b> entries including <b style="color:green">1,316</b> TFs, <b style="color:green">1,092</b> T Markers, <b style="color:green">473</b> I Markers, <b style="color:green">1,600</b> TFMarkers and <b style="color:green">1,424</b> TF Pmarkers, were annotated in <b style="color:green">383</b> cell types and <b style="color:green">95</b> tissue types in human. Moreover, TF-Marker divided markers into disease markers and tissue/cell-specific markers. TF-Marker is an elaborate database, which provides TFs and related markers supported by experimental evidence. We believe TF-Marker will provide strong support for research into cell/tissue-specific TFs and related markers.
                </p>
            </div>
        </div>
    </div>
                ...
                <div class="info">
                    <a href="search.php?gene_type=TF">
                        <p>Type 1(<strong style="color: #ff7f00">TF</strong>):
                            TF: <strong>TFs</strong>  which <strong>regulate</strong> expression of the <strong>markers</strong>;
                        </p>
                    </a>
                    <a href="search.php?gene_type=T Marker">
                        <p>Type 2(<strong style="color: #ff7f00">T Marker</strong>):
                            <strong>markers</strong> which are <strong>regulated</strong> by the <strong>TF</strong>
                        </p>
                    </a>
                    <a href="search.php?gene_type=I Marker">
                        <p>Type 3(<strong style="color: #ff7f00">I Marker</strong>):
                          <strong>marker</strong> which <strong>influences</strong> the activity of the
                            <strong>TF</strong>
                        </p>
                    </a>
                </div>
                ...
                <div class="info box-bottom">
                    <a href="search.php?gene_type=TF Pmarker">
                        <p>Type 5(<strong style="color: #ff7f00">TF Pmarker</strong>):
                            <strong>TFs</strong> which play roles as <strong>potential markers</strong>
                        </p>
                    </a>
                </div>
            </div>
                ...
                <div class="info">
                    <a href="search.php?gene_type=TFMarker">
                        <p>Type 4(<strong style="color: #ff7f00">TFMarker</strong>):
                            <strong>TFs</strong> which play roles as <strong>markers</strong>
                        </p>
                    </a>
                </div>
            </div>
