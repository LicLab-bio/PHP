...
while ($rows = mysqli_fetch_assoc($results)) {
    $Marker[] = $rows['ControlMarker'];
}
$Marker = join(";", $Marker);
$Markers = preg_split("/;+/i", $Marker);
$Marker_match = join("|", array_unique($Markers));
...
<div class="container">
                ...
                <div class="col-lg-6">
                    <div class="box box-color-1">
                        <table class="table table-hover">
                            ...
                            <tr>
                                <td><strong>ControlMarker:</strong></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="http://uniprot.org/uniprot/?query=<?php echo $tf_information_gene_symbol; ?>_HUMAN"
                                       target="blank"><img src="../public/img/uniport.png" height="25" width="80"></img></a>
                                </td>
                                <td><strong>Wikipedia:</strong></td>
                                <td><a href="http://en.wikipedia.org/wiki/<?php echo $tf_information_gene_symbol; ?>"
                                       target="blank"><img src="../public/img/wiki.png" height="25"
                                                           width="80"></img></a></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <a href="https://cancer.sanger.ac.uk/cosmic3d/protein/<?php echo $tf_information_gene_symbol; ?>"
                                       target="blank"><img src="../public/img/cosmic3d.png" height="25"
                                                           width="80"></img></a></td>
                                ...
                                <td>
                                    <a href="http://amigo.geneontology.org/amigo/medial_search?q=<?php echo $tf_information_gene_symbol; ?>&searchtype=all"
                                       target="blank"><img src="../public/img/go.png" height="25" width="80"></img></a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <a href="https://portals.broadinstitute.org/ccle/page?gene=<?php echo $tf_information_gene_symbol; ?>"
                                       target="blank"><img src="../public/img/ccle.png" height="25"
                                                           width="80"></img></a></td>
                            </tr>
                            </tbody>
                        </table>
    ...
    <div class="row">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                ?>
                <div class="box box-color-2">
                    <div id="tf2crc_bar" style="height: 500px"></div>
                </div>
                <div class="box box-color-1">
                    <br>
                    <table class="table table-hover table-bordered table-condensed" id="tf_num">
                        ...
                        foreach (["coltron", "crc_mapper"] as $tf_num) {
                            ...
                            while ($row = mysqli_fetch_assoc($res_tf_num)) {
                                ...
                                echo "<td><button type='button' class='btn btn-primary' onclick='crc_detail(`{$row["tf_num_sample_id"]}`,`$tf_num`)'>detail</button></td>";
                                echo "</tr>";
                            }
                        }
                        ?>
                ...
                <table class="table table-hover table-bordered table-condensed" cellspacing="0" id="first_crc">
                    ...
                    foreach (["coltron", "crc_mapper"] as $first_crc) {
                        ...
                        while ($row = mysqli_fetch_assoc($res_first_crc)) {
                            ...
                            echo "<td>{$row["sample_biosample_type"]}</td>";
                            echo "<td>{$row["sample_biosample_id"]}</td>";
                            echo "<td><button type='button' class='btn btn-primary' onclick='crc_detail(`{$row["first_crc_sample_id"]}`,`$first_crc`)'>detail</button></td>";
                            echo "</tr>";
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              ORDER BY
                ...
                ?>
                <div id="gene_regional_location" style="height: 500px"></div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <center><img src="../public/img/tf_detail_page_SEs_in_chromatin_distribution_help.png"
    ...
    <div class="row">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-7">
                        <?php echo '<a href="tf_mrna_manual.php?tf_name=' . $tf_name . '" type="button" class="btn btn-success" target="down_iframe">'; ?>
                        Gene</a>
                        <?php echo '<a href="tf_microrna_manual.php?tf_name=' . $tf_name . '" type="button" class="btn btn-success" target="down_iframe"">'; ?>
                        MicroRNA</a>
                        <?php echo '<a href="tf_lncrna_predict.php?tf_name=' . $tf_name . '" type="button" class="btn btn-primary" target="down_iframe"">'; ?>
                        LncRNA</a>
                    </div>
                    <div class="col-lg-5">
                ...
                <?php echo '<iframe onload="changeFrameHeight(this);" src="tf_mrna_manual.php?tf_name=' . $tf_name . '"  name="down_iframe"
                    scrolling="no"
                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td><a href="https://dcc.icgc.org/genes/<?php echo $tf_information_ensembl_id; ?>"
                                           target="blank"><img src="../public/img/icgc.png" height="50"
                                                               width="50"></img></a></td>
                                </tr>
                                </tbody>
                            </table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="https://cancer.sanger.ac.uk/cosmic/search?q=<?php echo $tf_information_gene_symbol; ?>"
                                           target="blank"><img src="../public/img/cosmic.png" height="25"
                                                               width="80"></img></a></td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a href="https://cancer.sanger.ac.uk/cell_lines/gene/analysis?ln=<?php echo $tf_information_gene_symbol; ?>"
                                           target="blank"><img src="../public/img/cosmic_cellline.png" height="25"
                                                               width="80"></img></a></td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a href="https://depmap.org/portal/gene/<?php echo $tf_information_gene_symbol; ?>?tab=overview"
                                           target="blank"><img src="../public/img/demap.png" height="25"
                                                               width="80"></img></a></td>
                                </tr>
                                </tbody>
                            </table>
    ...
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3>
                    <i class="ri-folder-info-line"></i> Upstream regulation of <font
                            color="red"><?php echo $tf_information_gene_symbol; ?></font>
                </h3>
            </div>
            <div class="panel-body">
                        ...
                        <div class="box box-color-1">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="https://www.kegg.jp/dbget-bin/www_bfind_sub?mode=bfind&max_hit=1000&dbkey=genes&keywords=<?php echo $tf_information_gene_symbol; ?>"
                                           target="blank"><img src="../public/img/kegg.gif" height="25"
                                                               width="80"></img></a></td>
                                </tr>
                                <tr>
                                    <td><strong>Wikipathways:</strong></td>
                                    <td>
                                        <a href="https://www.wikipathways.org//index.php?query=<?php echo $tf_information_gene_symbol; ?>&title=Special%3ASearchPathways&doSearch=1&sa=Search"
                                           target="blank"><img src="../public/img/ncbi.png" height="25"
                                                               width="80"></img></a></td>
                                </tr>
                                <tr>
                                    <td><strong>Pathwaycommon:</strong></td>
                                    <td>
                                        <a href="https://apps.pathwaycommons.org/search?type=Pathway&q=<?php echo $tf_information_gene_symbol; ?>&title=Special%3ASearchPathways&doSearch=1&sa=Search"
                                           target="blank"><img src="../public/img/pathwaycommon.png" height="20"
                                                               width="80"></img></a></td>
                                </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="box box-color-2">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="https://reactome.org/content/query?q=<?php echo $tf_information_gene_symbol; ?>&species=Homo+sapiens&species=Entries+without+species&cluster=true"
                                           target="blank"><img src="../public/img/Reactome.png" height="25"
                                                               width="80"></img></a></td>
                                </tr>
                                <tr>
                                    <td><strong>Pathcards:</strong></td>
                                    <td>
                                        <a href="https://pathcards.genecards.org/Search/Results?query=<?php echo $tf_information_gene_symbol; ?>"
                                           target="blank"><img src="../public/img/PathCards.png" height="25"
                                                               width="80"></img></a></td>
                                </tr>
                                </tbody>
                            </table>
    ...
    <div class="row">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                        <!-----<?php echo '<a href="gene_exp_gene_bar.php?tf_name=' . $tf_name . '&gene_exp_type=gene_exp_tcga" type="button" class="btn btn-primary" target="tf_exp_iframe">'; ?>Pan cancer (TCGA)</a>---------->
                        <?php echo '<a href="gene_exp_gene_bar.php?tf_name=' . $tf_name . '&gene_exp_type=gene_exp_cell_line_encode" type="button" class="btn btn-primary" target="tf_exp_iframe">'; ?>
                        Cell line (ENCODE)</a>
                        <?php echo '<a href="gene_exp_gene_bar.php?tf_name=' . $tf_name . '&gene_exp_type=gene_exp_in_vitro_differentiated_cell_encode" type="button" class="btn btn-primary" target="tf_exp_iframe">'; ?>
                        In vitro differentiated cell (ENCODE)</a>
                        <?php echo '<a href="gene_exp_gene_bar.php?tf_name=' . $tf_name . '&gene_exp_type=gene_exp_primary_cell_encode" type="button" class="btn btn-primary" target="tf_exp_iframe">'; ?>
                        Primary cell (ENCODE)</a>
                        <?php echo '<a href="gene_exp_gene_bar.php?tf_name=' . $tf_name . '&gene_exp_type=gene_exp_tissue_ncbi" type="button" class="btn btn-primary" target="tf_exp_iframe">'; ?>
                        Tissue (NCBI)</a>
                        <?php echo '<a href="gene_exp_gene_bar.php?tf_name=' . $tf_name . '&gene_exp_type=gene_exp_normal_tissue_gtex" type="button" class="btn btn-primary" target="tf_exp_iframe">'; ?>
                        Normal tissue (GTEx)</a>
                        <?php echo '<a href="gene_exp_gene_bar.php?tf_name=' . $tf_name . '&gene_exp_type=gene_exp_cell_line_ccle" type="button" class="btn btn-primary" target="tf_exp_iframe">'; ?>
                        Cell line (CCLE)</a>
                    </div>
                </div>
                <?php echo '<iframe onload="changeFrameHeight(this);" src="gene_exp_gene_bar.php?tf_name=' . $tf_name . '&gene_exp_type=gene_exp_tcga" name="tf_exp_iframe"
                    scrolling="no"
                    height="100%" width="100%" allowfullscreen="true" allowtransparency="true" frameborder="no"
                    border="0" marginwidth="0" marginheight="0"></iframe>' ?>
            </div>
...
<script>
    function crc_detail(sample_id, strategy) {
        $('#crc_detail_modal').modal('toggle');
        $("#crc_detail_modal_body").html("");
        $.ajax({
            url: "crc_sample_server.php",
            data: {
                sample_id: sample_id,
                marker_match: '<?php echo $Marker_match ?>',
                strategy: strategy
            },
            dataType: "HTML",
