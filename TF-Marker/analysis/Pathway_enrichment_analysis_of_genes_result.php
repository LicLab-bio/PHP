...
<div class="container-fluid" style="min-height: 1000px;">
    <div class="row">
        <div class="col-xs-12 col-lg-12">
            <div class="pull-right"><i class="ri-map-pin-line"></i>Analysis / Pathway enrichment analysis / <b
                        class="navigator">Detail</b></div>
        </div>
    </div>
    <br>
        ...
        <div class="panel-body">
            <div class="col-lg-6">
                <div class="box box-color-1">
                    <table class="table table-hover">
                        ...
                        <tr>
                            <td><strong>Control Marker:</strong></td>
            ...
            <div class="col-lg-6">
                <div class="box box-color-2">
                    ...
                    <div>
                        <center>
                            <img src="../public/img/analysis/Pathway_enrichment_analysis_of_genes_result/enrichment_red_ring.png"
                                 alt=" "> is the ControlMarker
                            <img src="../public/img/analysis/Pathway_enrichment_analysis_of_genes_result/grey.png"
                                 alt=" "> is the Repression
                            <img src="../public/img/analysis/Pathway_enrichment_analysis_of_genes_result/yellow.png"
    ...
    <?php if ($_POST["type"] == "Gene") { ?>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div>
                    <hr>
                    <h3><b><font color="red">Red</font></b> is the ControlMarker.</h3>
                </div>
            </div>
        </div>
    <?php } ?>
    <?php if ($_POST["type"] == "LncRNA") { ?>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3>
    ...
    <?php } ?>
    <?php if ($_POST["type"] == "miRNA") { ?>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3>
                    <i class="ri-folder-info-line"></i> miRNA regulated by <?php echo $tf_name; ?>
                </h3>
            </div>
            <div class="panel-body">
                <table id="tf_target_genes" class="table table-hover table-bordered table-condensed"
        ...
        series: [
            {
                ...
                categories: [{
                    'name': '<?php echo $_POST["type"] ?>',　//索引到category后面对应的值
                    itemStyle: {
                        normal: {
                            color: "#337ab7"
                        }
